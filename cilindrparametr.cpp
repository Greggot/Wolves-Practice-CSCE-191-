...
#include "ui_cilindrparametr.h"
#include "Engine.cpp"

CilindrParamtr::CilindrParamtr(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CilindrParamtr)
{
    ui->setupUi(this);
    this->setWindowTitle("Установка параметров цилиндра");
}

CilindrParamtr::~CilindrParamtr()
{
    delete ui;
}

void CilindrParamtr::on_ok_clicked()
{
