...
public:
    ...
    Cube(double BasicLine, Point cent)
    {
        this->cent = cent;
...
public:
    ...
    Prism_Cylinder(double BasicLine, double R, int number, Point cent)
    {
        this->cent = cent;
...
public:
    ...
    Pyramid_Cone(double FigureHeight, double Radius, int PointNumber, Point cent)
    {
...
public:
    ...
    Sphere (double Radius, double diffAngle)
    {
        this->Radius = Radius;
        this->cent = cent;
